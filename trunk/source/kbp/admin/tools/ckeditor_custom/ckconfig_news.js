CKEDITOR.editorConfig = function( config )
{
    ...
    config.extraPlugins = 'simplebox,codesnippet,filetools,notification,notificationaggregator,uploadwidget,uploadimage,image2,kbp_tooltip,video';
    ...
    [
        ...
        { name: 'kbp', items : [ 'KBPTooltip','KBPRemoveTooltip','Video'  ] }
    ];
