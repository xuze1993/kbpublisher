...
$rules['status'] = array(
    ...
    array('select' => array('func'   => array('this', 'getStatusSelectRange'), 'validate_func' => array('this', 'validateStatus'))),
    );

$rules['type'] = array(
    array('select' => array('option' => array('is', 'is_not'))),
    array('select' => array('func'   => array('this', 'getTypeSelectRange'), 'validate_func' => array('this', 'validateType'))),
    );
...
$actions['email_group_grouped']  = array(
    'r' => 'email_group_grouped',
    'func' => 'emailGroupGrouped');
...
$action_rules['email_group_grouped'] = array(
    array('select'   => array('func' => array('this', 'getGroupEmailRecipientSelectRange'), 'options' => 'onchange="checkForPopup(this)"')),
    array('email_subject' => array('value' => '')),
    array('email_body' => array('value' => ''))
);
