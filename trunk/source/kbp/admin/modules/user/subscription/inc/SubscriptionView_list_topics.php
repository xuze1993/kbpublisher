...
class SubscriptionView_list_topics extends SubscriptionView_list
{

    var $tmpl = 'articles_list.html';
    var $table_name = 'forum_topics';
    ...
    function execute(&$obj, &$manager) {  
        ...
        // note message
        $tpl->tplAssign('user_note_msg', AppMsg::hintBoxCommon('note_topic_subscribe'));
        ...
        foreach($entries as $row) {            
            ...
            $row['entry_link'] = $cc->getLink('topic', false, $row['id']);    
