...
class SubscriptionView_list_files extends SubscriptionView_list
{
    var $tmpl = 'files_list.html';
    ...
    function execute(&$obj, &$manager) {
        ...
        $this->addMsg('file/common_msg.ini');
        ...
        // note message
        $tpl->tplAssign('user_note_msg', AppMsg::hintBoxCommon('note_entry_subscribe'));
        ...
        foreach($entries as $row) {            
            ...
            $row['entry_link'] = $cc->getLink('download', false, $row['id']);    
