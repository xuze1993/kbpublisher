...
$controller->loadClass('LoginLog');
$controller->loadClass('LoginLogModel');
$controller->loadClass('LoginLogView_list');
...
case 'file': // ------------------------------
    ...
    $controller->loadClass('LoginLogExport');
    $export = new LoginLogExport;
