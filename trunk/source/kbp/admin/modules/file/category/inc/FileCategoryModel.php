...
require_once APP_MODULE_DIR . 'file/category/inc/FileCategoryModelBulk.php';


class FileCategoryModel extends CommonCategoryModel
{
    ...
    var $role_read_rule = 'file_category_to_role_read';
    var $role_read_id = 2;
    
    var $role_write_rule = 'file_category_to_role_write';
    var $role_write_id = 6;
    
    var $admin_user_rule = 'file_category_to_user_admin';
    var $admin_user_id = 4;
    
    var $show_bulk_sort = true;    
    var $entry_type = 12; // means file category, file type = 2
