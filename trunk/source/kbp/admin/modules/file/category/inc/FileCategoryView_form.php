...
class FileCategoryView_form extends AppView
{
    var $tmpl = 'form.html';
    ...
    function execute(&$obj, &$manager) {
        ...
        $tpl->tplAssign('category_popup_block', 
            CommonCategoryView::getCategoryPopupBlock($this->controller, $this->msg, 'file', 'file_category'));
        ...
        //$tpl->tplAssign('browseable_options', $this->getChecked($obj->get('browseable')));        
    ...
    function parsePrivateStuff(&$tpl, &$xajax, $obj, $manager) {
        $tpl->tplAssign('block_private_tmpl', 
            PrivateEntry::getPrivateCategoryBlock($xajax, $obj, $manager, $this, 'file', 'file_category'));
