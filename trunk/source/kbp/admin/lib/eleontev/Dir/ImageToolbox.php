...
/*
error_reporting(0);
$i = new Image_Toolbox('../city_night.jpg');
//$i->newOutputSize(100, 0, 1);

//           $text, $font, $size, $color,      $x,      $y,       $angle = 0
$i->addText('TEXT', 'Verdana', 15, '#252525', 'center', 'center', $angle = 0);
$i->addText('TEXT', 'Verdana', 15, '#ebebeb', 'center +2', 'center', $angle = 0);
$i->output();
*/

//$a = $i->getServerFeatures();
