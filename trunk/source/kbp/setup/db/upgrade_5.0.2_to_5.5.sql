...
--
DROP TABLE IF EXISTS `kbp_entry_draft_workflow`;
--
...
--
DROP TABLE IF EXISTS `kbp_entry_draft_workflow_history`;
--
...
--
DROP TABLE IF EXISTS `kbp_entry_featured`;
--
...
--
DROP TABLE IF EXISTS `kbp_entry_index`;
--
CREATE TABLE IF NOT EXISTS `kbp_entry_index` (
  `entry_id` int(10) unsigned NOT NULL,
  ...
  `private_read_role` text NOT NULL,
  `private_write_role` text NOT NULL,
  `author_id` int(10) unsigned NOT NULL DEFAULT '0',
  `date_updated` datetime NOT NULL,
  `date_indexed` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `active` smallint(5) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`entry_id`,`entry_type`),
  FULLTEXT KEY `title` (`title`),
  FULLTEXT KEY `alltext` (`title`,`body`,`meta_keywords`,`meta_description`)
) ENGINE=MyISAM ;

--
DROP TABLE IF EXISTS `kbp_entry_trash`;
--
...
--
DROP TABLE IF EXISTS `kbp_log_trigger`;
--
...
(61, 6, 0, 'export_kb', 'Export KB', 'NO', '', 0, 1, 0, NULL, NULL, 1, 1),
...
(7, 0, 0, 'import', 'Import', 'NO', 'import_user', 0, 1, 0, 'select,insert', NULL, 190, 1),
(72, 7, 0, 'import_article', 'Import Articles', 'NO', '', 0, 1, 0, 'select,insert', NULL, 2, 1),
(71, 7, 0, 'import_user', 'Import Users', 'NO', '', 0, 1, 0, 'select,insert', NULL, 1, 1),
...
(9, 0, 0, 'home', 'Home', 'NO', 'home', 0, 1, 0, NULL, NULL, 1, 1),
(90, 9, 0, 'home', 'Home', 'NO', '', 0, 0, 0, NULL, NULL, 1, 1),
(150, 3, 0, 'licence_setting', 'Licence', 'NO', '', 0, 1, 0, 'select,insert,update', NULL, 30, 1),
...
(98, 0, 0, 'trash', 'Trash', NULL, '', 0, 1, 0, 'select,update,delete', NULL, 999, 2),
(75, 7, 0, 'import_glossary', 'Import Glossary', 'NO', '', 0, 1, 0, 'select,insert', NULL, 3, 1),
...
(2203, 220, 0, 'field_tool', 'Custom Fields', 'NO', 'field_tool', 0, 1, 0, NULL, NULL, 7, 1),
...
(4034, 403, 0, 'rs_user', 'Users', 'NO', '', 0, 0, 0, NULL, NULL, 6, 1),
...
(6, 0, 0, 'export', 'Export', 'NO', 'export_kb', 0, 1, 0, NULL, NULL, 191, 1),
...
(4035, 403, 0, 'rs_feedback', 'Feedback', 'NO', '', 0, 0, 0, NULL, NULL, 5, 1),
(4037, 403, 0, 'rs_subscriber', 'Subscribers', 'NO', '', 0, 0, 0, NULL, NULL, 7, 0),
(76, 7, 0, 'kb_glossary', 'Glossary', 'NO', '', 0, 2, 0, NULL, NULL, 11, 1),
(140, 3, 0, 'plugin_setting', 'Plugins', 'NO', '', 0, 1, 0, 'select,insert,update', NULL, 29, 1),
(91, 9, 0, 'kbpreport', 'Setup Report', 'NO', '', 0, 1, 0, 'select,update', NULL, 3, 1),
(15, 1, 0, 'ban', 'Ban', 'NO', '', 0, 1, 0, NULL, NULL, 6, 0),
(160, 3, 0, 'auth_setting', 'LDAP', 'NO', '', 0, 1, 0, 'select,update', NULL, 22, 1),
...
(22031, 2203, 0, 'field_tool', 'Custom Fields', 'NO', '', 0, 0, 0, NULL, NULL, 1, 1),
(22032, 2203, 0, 'field_tool_range', 'Field Ranges', 'NO', '', 0, 0, 0, NULL, NULL, 2, 1),
...
(63, 6, 0, 'export_article', 'Export Articles', 'NO', '', 0, 1, 0, NULL, NULL, 5, 1),
(404, 400, 0, 'report_entry', 'Entry Usage', 'NO', '', 0, 1, 0, 'select', NULL, 3, 1),
(106, 100, 0, 'kb_featured', 'Featured', 'NO', '', 0, 1, 0, NULL, NULL, 3, 1),
...
--
DROP TABLE IF EXISTS `kbp_report_entry`;
--
...
(19, 2, 0, 0, 1, 2, '', 'nav_title', '', '', 'KB Home', 7, 0, 1, 1),
...
(101, 2, 0, 0, 1, 2, '', 'header_title', '', '', 'Knowledgebase', 6, 0, 1, 1),
...
(135, 2, 0, 0, 8, 1, '', 'view_menu_type', '', '1', 'followon', 5, 0, 0, 1),
...
(281, 1, 0, 0, 15, 1, '', 'timezone', '', 'dinamic', 'system', 2, 0, 0, 1),
...
(289, 2, 0, 0, 1, 8, '', 'header_logo', '', '', '', 5, 0, 1, 1),
...
(300, 2, 0, 0, 16, 2, '', 'search_spell_bing_key', '', '', '', 8, 0, 1, 1),
(301, 2, 0, 0, 16, 2, '', 'search_spell_bing_url', '', '', '', 9, 0, 1, 1),
(302, 2, 0, 0, 16, 2, '', 'search_spell_enchant_provider', '', '', '', 10, 0, 1, 1),
(303, 2, 0, 0, 16, 2, '', 'search_spell_enchant_dic', '', '', '', 11, 0, 1, 1),
(304, 2, 0, 0, 16, 2, '', 'search_spell_bing_autocomplete', '', '', '', 11, 0, 1, 1),
...
--
DROP TABLE IF EXISTS `kbp_trigger`;
--
...
--
ALTER TABLE `kbp_user` ADD `date_updated` TIMESTAMP ON UPDATE CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER `date_registered`;


--
ALTER TABLE `kbp_news` CHANGE `date_updated` `date_updated` TIMESTAMP ON UPDATE CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER `updater_id`;


--
ALTER TABLE `kbp_letter_template` ADD group_id tinyint(3) unsigned NOT NULL DEFAULT '0' AFTER id;
--
UPDATE `kbp_letter_template` SET group_id = 1 WHERE letter_key IN ('comment_approve_to_admin', 'article_approved', 'article_approve_to_user', 'article_approve_to_admin', 'rating_comment_added', 'article_added', 'article_updated');
--
UPDATE `kbp_letter_template` SET group_id = 2 WHERE letter_key IN ('file_approve_to_admin', 'file_approve_to_user', 'file_approved', 'file_added', 'file_updated');
--
UPDATE `kbp_letter_template` SET group_id = 3 WHERE letter_key IN ('confirm_registration', 'generated_password', 'user_approve_to_admin', 'user_approve_to_user', 'user_approved', 'user_added', 'user_updated', 'reset_password');
--
UPDATE `kbp_letter_template` SET group_id = 4 WHERE letter_key IN ('send_to_friend', 'answer_to_user', 'contact', 'scheduled_entry', 'subscription_news', 'subscription_entry', 'subscription_comment');


--
INSERT INTO `kbp_list_value` SELECT NULL,1,'outdated',MAX(list_value)+1,'','',1,5,0,'#FFFF00','',1,0 FROM `kbp_list_value` WHERE list_id = 1 AND list_value < 21;
--
INSERT INTO `kbp_list_value` SELECT NULL,2,'outdated',MAX(list_value)+1,'','',1,5,0,'#FFFF00','',1,0 FROM `kbp_list_value` WHERE list_id = 2 AND list_value < 21;


--
UPDATE `kbp_priv_module` SET `status_priv` = '1' WHERE `id` IN(101,201,501);


--
ALTER TABLE `kbp_priv_rule` ADD `optional_priv` VARCHAR(256) NOT NULL AFTER `status_priv`;

 
--
INSERT INTO `kbp_priv_rule` VALUES ('3', '103', 'select,insert,update,status,delete', '', '', '0',  '1'),
...
--
UPDATE `kbp_priv_rule` SET `optional_priv` = 'a:2:{s:6:"insert";a:1:{i:0;s:5:"draft";}s:6:"update";a:1:{i:0;s:5:"draft";}}' WHERE `priv_name_id` = 5 AND `priv_module_id` = 101;


--
INSERT INTO `kbp_priv_rule` VALUES ('3', '203', 'select,insert,update,status,delete', '', '', '0',  '1'),
...
--
UPDATE `kbp_priv_rule` SET `optional_priv` = 'a:2:{s:6:"insert";a:1:{i:0;s:5:"draft";}s:6:"update";a:1:{i:0;s:5:"draft";}}' WHERE `priv_name_id` = 5 AND `priv_module_id` = 201;



--
ALTER TABLE `kbp_article_template` ADD `is_widget` tinyint(1) NOT NULL DEFAULT '0' AFTER `description`;


--
UPDATE `kbp_priv_module` SET `extra_priv` = 'draft' WHERE `id` = 205;



--
INSERT INTO `kbp_letter_template` VALUES
(30, 5, 'draft_approval_request', '', '', '[noreply_email]', '', '[email]', '', '', '', '', '', NULL, '', NULL, 'to', 'entry_type,title,comment', '', 0, 1, 1, 1, 1),
(31, 5, 'draft_rejection', '', '', '[noreply_email]', '', '[email]', '', '', '', '', '', NULL, '', NULL, 'to', 'entry_type,title,comment', '', 0, 1, 1, 1, 2),
(32, 5, 'draft_publication', '', '', '[noreply_email]', '', '[email]', '', '', '', '', '', NULL, '', NULL, 'to', 'entry_type,title,comment', '', 0, 1, 1, 1, 5),
(33, 5, 'draft_rejection_to_approver', '', '', '[noreply_email]', '', '[email]', '', '', '', '', '', NULL, '', NULL, 'to', 'entry_type,title,comment', '', 0, 1, 1, 1, 3);


--
UPDATE `kbp_letter_template` SET `extra_tags` = 'content,unsubscribe_link,account_link' WHERE `id` IN (26,28);
--
UPDATE `kbp_letter_template` SET `extra_tags` = 'new_article,updated_article,commented_article,new_file,updated_file,unsubscribe_link,account_link' WHERE `id` = 27;


--
ALTER TABLE `kbp_entry_rule` ADD `is_draft` TINYINT UNSIGNED NOT NULL DEFAULT '0' AFTER `parse_child`;
